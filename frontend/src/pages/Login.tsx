      ...
      <div className="w-full max-w-md space-y-8 glass-card p-8 rounded-2xl border">
        <div className="text-center space-y-2">
          <div className="inline-flex items-center justify-center w-16 h-16 mb-4">
            <img src="/logo.png" alt="Thompson Finance" className="w-full h-full object-contain" />
          </div>
          <h1 className="text-2xl font-display font-bold tracking-tight whitespace-nowrap">Thompson Finance</h1>
